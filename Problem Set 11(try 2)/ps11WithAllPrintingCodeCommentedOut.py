...
class RectangularRoom(object):
    ...
    def isTileCleaned(self, m, n):
        ...
        #print 'the tile at:',(math.floor(m),math.floor(n)),
        ...
        #print '----------------------------------------------------------'
        #print 'all the cleaned tiles till now:'
        ...
        #print 'the tile at:',(m,n),

        for i in self.cleanedTiles:            

            if i.x == m and i.y == n:

                #print 'is already cleaned'

                return True

        #print ' has not yet been cleaned'
    ...
    def getRandomPosition(self):
        ...
        #print (pos.x,pos.y),' has been randomly generated'
...
class Robot(BaseRobot):
    ...
    def updatePositionAndClean(self):
        ...
        #print (self.p.x,self.p.y),' has been generated'

        if not self.room.isPositionInRoom(self.p):  ##if the position is not in the room

            #print 'which is not inside the room'
            ...
            while not self.room.isPositionInRoom(newPos):               
                ...
                #print 'the new direction is:',self.d
                #print 'the new position generated is:',(newPos.x,newPos.y)
            ...
            #print 'the final position as generated by random directions is:',(newPos.x,newPos.y)
...
##            anim = ps11_visualize.RobotVisualization(num_robots, width, height)
        ...
        #while abs(areaCovered - min_coverage) > epsilon:

        while areaCovered < min_coverage:

##            print areaCovered
##            print min_coverage
##            print (areaCovered < min_coverage)

##            if not areaCovered < min_coverage:
##
##                break                

            #if areaCovered - min_coverage < 0:

                #break

            #print 'time step:',len(listForThisTrial)
...
avg = runSimulation(1,1,5,5,1,30,Robot,False)
