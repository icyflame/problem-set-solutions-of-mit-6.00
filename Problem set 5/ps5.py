## The 6.00 word game. Basic version
...
def is_valid_word(word, hand, word_list):
    ...
    for i in range(len(given_word)):
        if given_hand.get(given_word[i],-1)==-1:  ##that is this letter is not there in the hand
            return False
...
def play_hand(hand, word_list):
    ...
    * The final score is displayed.
    ...
    while(len(hand)>0):          
        ...
        print 'This word is valid. Your score is:',score
