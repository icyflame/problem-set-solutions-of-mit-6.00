...
##                break
        ...
        if work_done + subjects[key2][WORK]<=maxWork:
            ...
            i+=1
            print
            print key2,' is the best'
            print key2, ' has been removed'
            print i,' subjects have been included'
...
##print
##print
##selected = greedyAdvisor(smallCatalog,15,cmpValue)
##print
##print
##printSubjects(selected)
