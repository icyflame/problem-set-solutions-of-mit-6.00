##The 6.00 word game. This has time limit for each player and points are not
##awarded if the time limit is exceeded
    ...
    * The final score is displayed.
    ...
    while(len(hand)>0):
        ...
        if(time_total > time_limit):
            print 'The time limit has been exceeded'
            break
        ...
        time_rem = time_limit - time_total
        score += (get_word_score(ch,HAND_SIZE))/time_taken
        print 'It took you %0.2f seconds to enter your answer' % time_taken
        print 'Time remaining is: %0.2f' % time_rem
        print 'This word is valid. Your score is: %0.2f' % score
...
if __name__ == '__main__':
    ...
    time_limit = float(raw_input('Enter the time limit for each player:'))
    play_game(word_list)
