...
class RectangularRoom(object):
    ...
    def isTileCleaned(self, m, n):
        ...
        return (Position(m,n) in cleanedTiles)
    ...
    def isPositionInRoom(self, pos):
        ...
        return ((pos.x < self.w) and (pos.y < self.h))
...
class BaseRobot(object):
    ...
    def __init__(self, room, speed):
        ...
        seld.d = random.choice(range(360))
...
class Robot(BaseRobot):
    ...
    def updatePositionAndClean(self):
        ...
        if not self.room.isTileCleaned(newPos):
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in range(num_robots):
        robots.apppend(robot_type(room,speed))

    for i in range(num_trials):

        while cleanedRatio <= min_coverage:
            for i in range(num_robots):
