...
class Position(object):
    ...
    def __str__(self):
        return ('%0.2f' %self.x + ',' + '%0.2f' %self.y)
...
class Robot(BaseRobot):
    ...
    def updatePositionAndClean(self):
        ...
        print 'the old position is:',self.p

        c = self.p.copy()

        n = c.getNewPosition(self.d,self.speed)
        
        print 'heading is:',self.d

        print 'speed is:',self.speed

        while not self.room.isPositionInRoom(n):
            print '   this position is not inside room'
            
            self.d = random.choice(range(360))

            np = c.getNewPosition(self.d,self.speed)
            
        print 'the new position is:',n
##
...
##            print '-----------------------'
##
##            print 'the random direction is calculated to be:',self.d
##
##            np = self.p.getNewPosition(self.d,self.speed)
##
##            print 'the new position is:',self.p
##
##            print '----------------------------'
##
##            print
...
##        self.p = np.copy()
##
##        if self.room.isTileCleaned(self.p.getX(),self.p.getY()):
##            print 'tile was already cleaned'
##
##        else:
##
##            print 'the tile has been cleaned now:',
##
##            print self.p
##
##        if not self.room.isTileCleaned(self.p.getX(),self.p.getY()):        
##
...
#avg1 = runSimulation(1,1.0,5,5,1,1,Robot,False)
...
for i in range(100):
    ...
    n = c.getNewPosition(r.d,r.speed)

    while not r.room.isPositionInRoom(n):
        r.d = random.choice(range(360))
